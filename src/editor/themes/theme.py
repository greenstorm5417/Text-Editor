...
class Theme:
    ...
    SIDEBAR_BACKGROUND_COLOR = QColor("#2D2D2D")
    SIDEBAR_BUTTON_COLOR = QColor("#3D3D3D")
    SIDEBAR_BUTTON_HOVER_COLOR = QColor("#4D4D4D")
    SIDEBAR_BUTTON_ACTIVE_COLOR = QColor("#5D5D5D")
    SIDEBAR_ICON_COLOR = QColor("#FFFFFF")
    SIDEBAR_BORDER_COLOR = QColor("#1D1D1D")
    SIDEBAR_WIDTH = 50

    # File Tree Theme Properties
    FILE_TREE_BACKGROUND_COLOR = QColor("#2D2D2D")
    FILE_TREE_TEXT_COLOR = QColor("#D4D4D4")
    FILE_TREE_SELECTED_BACKGROUND = QColor("#094771")
    FILE_TREE_SELECTED_TEXT_COLOR = QColor("#FFFFFF")
    FILE_TREE_HOVER_BACKGROUND = QColor("#2A2D2E")
    FILE_TREE_GRID_COLOR = QColor("#383838")
    FILE_TREE_HEADER_BACKGROUND = QColor("#252526")
    FILE_TREE_HEADER_TEXT_COLOR = QColor("#CCCCCC")
    FILE_TREE_CONTAINER_WIDTH = 250
    
    # Button Theme Properties
    TOOLBAR_BUTTON_HEIGHT = 30
    TOOLBAR_BUTTON_WIDTH = 30
    TOOLBAR_BUTTON_MARGIN = 5
