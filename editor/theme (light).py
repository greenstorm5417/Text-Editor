...
class Theme:
    ...
    # Color Definitions
    # Main UI Colors
    BACKGROUND_COLOR = QColor("#F3F3F3")
    TEXT_COLOR = QColor("#333333")
    HOVER_COLOR = QColor("#E0E0E0")
    LINE_COLOR = QColor("#CCCCCC")

    # Editor Colors
    EDITOR_BACKGROUND_COLOR = QColor("#FFFFFF")
    EDITOR_TEXT_COLOR = QColor("#1E1E1E")
    EDITOR_CURSOR_COLOR = QColor("#000000")
    EDITOR_SELECTION_BACKGROUND = QColor("#ADD6FF")
    EDITOR_CURRENT_LINE_COLOR = QColor("#F2F2F2")
    EDITOR_WHITESPACE_COLOR = QColor("#E0E0E0")

    # Line Number Colors
    EDITOR_LINE_NUMBER_BACKGROUND = QColor("#F3F3F3")
    EDITOR_LINE_NUMBER_COLOR = QColor("#888888")
    EDITOR_ACTIVE_LINE_NUMBER_COLOR = QColor("#000000")

    # Scrollbar Colors
    EDITOR_SCROLLBAR_BACKGROUND = QColor("#E0E0E0")
    EDITOR_SCROLLBAR_HANDLE = QColor("#CCCCCC")
    EDITOR_SCROLLBAR_HANDLE_HOVER = QColor("#B0B0B0")

    # Tab Colors
    TAB_BACKGROUND_COLOR = QColor("#E0E0E0")
    TAB_ACTIVE_BACKGROUND_COLOR = QColor("#FFFFFF")
    TAB_HOVER_BACKGROUND_COLOR = QColor("#F2F2F2")
    TAB_TEXT_COLOR = QColor("#333333")
    TAB_BORDER_COLOR = QColor("#CCCCCC")

    # Special Colors
    CLOSE_BUTTON_HOVER_COLOR = QColor("#FF6B6B")
    ICON_TEXT_COLOR = QColor("#333333")
    CURSOR_COLOR = QColor("#000000")
    CURSOR_WIDTH = 2
